...
class SettingsPage(BasePage):
    ...
    def _build_sections(self) -> None:
        ...
        self.shortcut_table.verticalHeader().setDefaultSectionSize(46)
        shortcut_header = self.shortcut_table.horizontalHeader()
        shortcut_header.setSectionResizeMode(0, QHeaderView.ResizeMode.Stretch)
        shortcut_header.setSectionResizeMode(1, QHeaderView.ResizeMode.Fixed)
        shortcut_header.setSectionResizeMode(2, QHeaderView.ResizeMode.ResizeToContents)
        shortcut_header.setSectionResizeMode(3, QHeaderView.ResizeMode.Fixed)
        shortcut_header.resizeSection(1, 172)
        shortcut_header.resizeSection(3, 156)
